...
// send mail
const sendMailProductDeliverd = async (to, txt) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
              ...
              <p>Congratulation! Your product successfully deliverd. Thanks for the buying product. Buy again.
              </p>
              </div>
            `,
    };
...
module.exports = sendMailProductDeliverd;
