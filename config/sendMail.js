  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
              ...
              <h2 style="text-align: center; text-transform: uppercase;color: #f4a51c;">Welcome to Simbaa Shop</h2>
              <p>Congratulations! You're almost set to start using Simbaa Shop.
